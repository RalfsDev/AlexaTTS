...
*/
	...
	function ALEXA_getDevices($basic_url, $cookies){
		$devices = array();
		$ch = curl_init();
	...
	function ALEXA_TTS($basic_url, $cookies, $devices, $device_name, $text_tts){
		//variables
...
<html>
	...
	<?php
		...
		$devices = ALEXA_getDevices($basic_url, $cookies);
        ...
        ALEXA_TTS($basic_url, $cookies, $devices, $device_name, $text_tts);
	?>
	</body>
</html>